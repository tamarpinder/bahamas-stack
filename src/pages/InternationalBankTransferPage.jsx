...
export default function InternationalBankTransferPage({ onBack }) {
  ...
  const countries = [
    'United States', 'Canada', 'United Kingdom', 'Jamaica', 'Barbados', 
    'Trinidad & Tobago', 'Cayman Islands', 'Turks & Caicos', 'Haiti', 
    'Dominican Republic', 'Cuba', 'Mexico', 'Germany', 'France', 'Other'
  ];
  ...
  const validateForm = () => {
    ...
    if (!transferData.recipientCountry) {
      newErrors.recipientCountry = 'Please select recipient country';
    }
    
    if (!transferData.recipientBank.trim()) {
      newErrors.recipientBank = 'Please enter recipient bank name';
    }
    ...
    if (!transferData.swiftCode || transferData.swiftCode.length < 8) {
      newErrors.swiftCode = 'Please enter a valid SWIFT code (8-11 characters)';
    }
    ...
    if (parseFloat(transferData.amount) > 25000) {
      newErrors.amount = 'Amount cannot exceed $25,000 for demo purposes';
    }
          ...
          <ScrollView style={styles.countryList}>
            {countries.map((country) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  handleInputChange('recipientCountry', country);
    ...
    <ScrollView style={styles.content}>
      <View style={styles.card}>
        <View style={styles.serviceHeader}>
          ...
          <View>
            <Text style={styles.serviceTitle}>International Transfer</Text>
            <Text style={styles.serviceSubtitle}>Send money worldwide</Text>
          </View>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.field}>
            <Text style={styles.fieldLabel}>Recipient Country</Text>
            <TouchableOpacity
              style={[styles.fieldInput, styles.dropdownInput, errors.recipientCountry && styles.errorInput]}
              onPress={() => setShowCountryPicker(true)}
            >
              <Text style={[styles.dropdownText, !transferData.recipientCountry && styles.placeholderText]}>
                {transferData.recipientCountry || "Select recipient's country"}
              </Text>
              <Ionicons name="chevron-down" size={20} color="#6B7280" />
            </TouchableOpacity>
            {errors.recipientCountry && (
              <Text style={styles.errorText}>{errors.recipientCountry}</Text>
            )}
          </View>
          ...
          <View style={styles.field}>
            ...
            <TextInput
              style={[styles.fieldInput, errors.recipientBank && styles.errorInput]}
              value={transferData.recipientBank}
              onChangeText={(value) => handleInputChange('recipientBank', value)}
          ...
          <View style={styles.field}>
            ...
            <TextInput
              style={[styles.fieldInput, errors.swiftCode && styles.errorInput]}
              value={transferData.swiftCode}
              onChangeText={(value) => handleInputChange('swiftCode', value.toUpperCase())}
  ...
  const renderConfirmation = () => (
    <ScrollView style={styles.content}>
      <View style={styles.card}>
        <Text style={styles.confirmationTitle}>Confirm International Transfer</Text>
        ...
        <View style={styles.confirmationDetails}>
          ...
          <View style={styles.confirmationRow}>
            <Text style={styles.confirmationLabel}>Country</Text>
            <Text style={styles.confirmationValue}>{transferData.recipientCountry}</Text>
          </View>
          ...
          <View style={styles.confirmationRow}>
            <Text style={styles.confirmationLabel}>SWIFT Code</Text>
            <Text style={styles.confirmationValue}>{transferData.swiftCode}</Text>
          </View>
          ...
          <View style={styles.confirmationRow}>
            ...
            <Text style={[styles.confirmationValue, styles.feeText]}>$15.00</Text>
          </View>
        </View>
      ...
      <TouchableOpacity style={styles.confirmButton} onPress={handleTransfer}>
        <Text style={styles.buttonText}>Transfer ${(parseFloat(transferData.amount) + 15).toFixed(2)}</Text>
      </TouchableOpacity>
  ...
  const renderProcessing = () => (
    <View style={styles.processingContainer}>
      ...
      <Text style={styles.processingSubtitle}>International transfers may take 1-3 business days...</Text>
    </View>
  );
  ...
  const renderSuccess = () => (
    <ScrollView style={styles.content}>
      <View style={styles.successContainer}>
        ...
        <Text style={styles.successSubtitle}>Your international transfer to {transferData.recipientName} has been submitted</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.transactionDetails}>
          <View style={styles.transactionRow}>
            ...
            <Text style={styles.transactionValue}>IBT{Date.now().toString().slice(-6)}</Text>
          </View>
          ...
          <View style={styles.transactionRow}>
            <Text style={styles.transactionLabel}>Transfer Fee</Text>
          ...
          <View style={styles.transactionRow}>
            ...
            <Text style={[styles.transactionValue, styles.statusProcessing]}>Processing</Text>
          </View>
        </View>
      </View>
  ...
  const getHeaderTitle = () => {
    switch (step) {
      case 'form': return 'International Transfer';
      case 'confirm': return 'Confirm Transfer';
      case 'processing': return 'Processing';
      case 'success': return 'Transfer Initiated';
