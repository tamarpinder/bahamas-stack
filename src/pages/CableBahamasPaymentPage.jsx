...
export default function CableBahamasPaymentPage({ onBack }) {
      ...
      <View style={styles.card}>
        <View style={styles.serviceHeader}>
          <View style={styles.serviceIcon}>
            <Ionicons name="tv" size={32} color="#8B5CF6" />
          </View>
          <View>
            <Text style={styles.serviceTitle}>Cable Bahamas</Text>
            <Text style={styles.serviceSubtitle}>Pay your cable and internet bill</Text>
          </View>
        </View>
        ...
        <View style={styles.form}>
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="Enter your Cable Bahamas account number"
      ...
      <View style={styles.card}>
        ...
        <View style={styles.confirmationDetails}>
          <View style={styles.confirmationRow}>
            ...
            <Text style={styles.confirmationValue}>Cable Bahamas</Text>
          </View>
  ...
  const renderSuccess = () => (
    <ScrollView style={styles.content}>
      <View style={styles.successContainer}>
        ...
        <Text style={styles.successSubtitle}>Your Cable Bahamas bill has been paid successfully</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.transactionDetails}>
          <View style={styles.transactionRow}>
            ...
            <Text style={styles.transactionValue}>CBL{Date.now().toString().slice(-6)}</Text>
          </View>
  ...
  const getHeaderTitle = () => {
    switch (step) {
      ...
      default: return 'Cable Bahamas Payment';
    }
  };
