...
export default function WaterSeweragePaymentPage({ onBack }) {
    ...
    <ScrollView style={styles.content}>
      <View style={styles.card}>
        <View style={styles.serviceHeader}>
          ...
          <View>
            <Text style={styles.serviceTitle}>Water & Sewerage</Text>
            <Text style={styles.serviceSubtitle}>Pay your water and sewerage bill</Text>
          </View>
        </View>
        ...
        <View style={styles.form}>
          <View style={styles.field}>
            ...
            <TextInput
              ...
              placeholder="Enter your Water & Sewerage account number"
      ...
      <View style={styles.card}>
        ...
        <View style={styles.confirmationDetails}>
          <View style={styles.confirmationRow}>
            ...
            <Text style={styles.confirmationValue}>Water & Sewerage Corporation</Text>
          </View>
  ...
  const renderSuccess = () => (
    <ScrollView style={styles.content}>
      <View style={styles.successContainer}>
        ...
        <Text style={styles.successSubtitle}>Your Water & Sewerage bill has been paid successfully</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.transactionDetails}>
          <View style={styles.transactionRow}>
            ...
            <Text style={styles.transactionValue}>WSC{Date.now().toString().slice(-6)}</Text>
          </View>
  ...
  const getHeaderTitle = () => {
    switch (step) {
      ...
      default: return 'Water & Sewerage Payment';
    }
  };
